...
AT_DECLARE_MEMBER_FUNC_NOARG(reflect::Type, get_functions, const std::vector<reflect::MemberFunction*>&)
AT_DECLARE_MEMBER_FUNC_OVERLOAD(reflect::Type, get_functions, std::vector<reflect::MemberFunction*>, std::vector<reflect::Type*>)
AT_DECLARE_MEMBER_FUNC_OVERLOAD(reflect::Type, get_functions, std::vector<reflect::MemberFunction*>, std::string)
