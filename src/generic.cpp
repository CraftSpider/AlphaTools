...
/**
 * Get the username of the current user, on any supported systems
 *
...
/**
 * Get the name of the computer the program is running on, on any supported systems
 *
...
/**
 * Demangle a symbol generated by the compiler used to compile this code, if the compiler supports such a feature.
 * Will throw an error if the builtin demangler fails.
 *
