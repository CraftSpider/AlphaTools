...
#define TEST_VARIADIC_2(...) AT_EXPAND(AT_VARIADIC_TWO(__VA_ARGS__, "B", "A", "INVALID"))
...
void test_variadic_2() {
    std::string arg1 = TEST_VARIADIC_2(A);
    
    AT_ASSERT(arg1 == "A");
    
    std::string arg2 = TEST_VARIADIC_2(A, B);
    
    AT_ASSERT(arg2 == "B");
}

void test_variadic_3() {
...
void run_macro_tests() {
    TEST(test_stringify)
    TEST(test_variadic_2)
    TEST(test_variadic_3)
}
